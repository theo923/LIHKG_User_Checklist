           ...
           <div className="flex flex-wrap gap-10 mt-5">
            ...
            <div className="flex flex-wrap gap-10 mt-5">
                <div>
                    ...
                    <input name='phoneNumber' onChange={e => handleDeliveryInfo(e)} type="text" type='number' placeholder="Phone Number" className="input input-bordered" />
                </div>
                <div>
                    <label className="label">
